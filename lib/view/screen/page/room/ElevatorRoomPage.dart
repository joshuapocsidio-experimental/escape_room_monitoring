...
class ElevatorRoomPage extends StatefulWidget {
  final String roomName;
  final String roomID;
  final String maxTime;

  ElevatorRoomPage({required this.roomName, required this.roomID, required this.maxTime});

  @override
  _ElevatorRoomPageState createState() => _ElevatorRoomPageState();
}

class _ElevatorRoomPageState extends State<ElevatorRoomPage> {
